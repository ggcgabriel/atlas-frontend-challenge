...
export const PROFESSIONS: ProfessionSeed[] = [
    ...
    services: [
      {
        ...
        durationMinutes: 90,
        rateMultiplier: [1, 1.6],
      },
      {
        title: 'Troca de disjuntor',
        durationMinutes: 60,
        rateMultiplier: [0.8, 1.2],
      },
      {
        title: 'Instalação de tomadas e interruptores',
        durationMinutes: 120,
        rateMultiplier: [1.2, 2],
      },
      {
        title: 'Revisão do quadro de distribuição',
        durationMinutes: 180,
        rateMultiplier: [2, 3.2],
      },
      {
        title: 'Instalação de ventilador de teto',
        durationMinutes: 90,
        rateMultiplier: [1, 1.5],
      },
      {
        title: 'Aterramento residencial',
        durationMinutes: 240,
        rateMultiplier: [2.5, 4],
      },
    ],
  },
  {
    name: 'Técnico em Ar-Condicionado',
    namePlural: 'Técnicos em Ar-Condicionado',
    ...
    services: [
      {
        title: 'Instalação de split 9.000 BTUs',
        durationMinutes: 240,
        rateMultiplier: [2, 3.5],
      },
      {
        title: 'Instalação de split 12.000 BTUs',
        durationMinutes: 240,
        rateMultiplier: [2.2, 3.8],
      },
      {
        title: 'Limpeza e higienização completa',
        durationMinutes: 120,
        rateMultiplier: [1, 1.8],
      },
      {
      ...
      },
      {
        ...
        durationMinutes: 90,
        rateMultiplier: [0.9, 1.5],
      },
      {
        title: 'Reparo de vazamento na tubulação',
        durationMinutes: 180,
        rateMultiplier: [1.8, 3],
      },
    ],
  },
  {
    name: 'Técnico em Eletrodomésticos',
    namePlural: 'Técnicos em Eletrodomésticos',
    ...
    services: [
      {
        ...
        durationMinutes: 120,
        rateMultiplier: [1.2, 2.2],
      },
      {
        title: 'Reparo de geladeira',
        durationMinutes: 120,
        rateMultiplier: [1.3, 2.4],
      },
      {
        title: 'Conserto de micro-ondas',
        durationMinutes: 60,
        rateMultiplier: [0.8, 1.4],
      },
      {
      ...
      {
        title: 'Troca de resistência de secadora',
        durationMinutes: 90,
        rateMultiplier: [1, 1.6],
      },
    ],
  },
  {
    ...
    services: [
      {
        title: 'Desentupimento de pia ou ralo',
        durationMinutes: 90,
        rateMultiplier: [1, 1.6],
      },
      {
        title: 'Caça-vazamento não destrutivo',
        durationMinutes: 180,
        rateMultiplier: [2, 3.5],
      },
      {
        title: 'Troca de registro',
        durationMinutes: 90,
        rateMultiplier: [1, 1.5],
      },
      {
        ...
        durationMinutes: 120,
        rateMultiplier: [1.3, 2.2],
      },
      {
        title: 'Troca de sifão e flexíveis',
        durationMinutes: 60,
        rateMultiplier: [0.7, 1.2],
      },
      {
        title: 'Instalação de filtro de água',
        durationMinutes: 90,
        rateMultiplier: [1, 1.6],
      },
    ],
  },
  {
    ...
    namePlural: 'Instaladores de Aquecedor',
    ...
    services: [
      ...
      {
        title: 'Manutenção de aquecedor',
        durationMinutes: 120,
        rateMultiplier: [1.2, 2],
      },
      {
        title: 'Instalação de boiler solar',
        durationMinutes: 480,
        rateMultiplier: [4, 7],
      },
      {
        title: 'Conversão de gás GN para GLP',
        durationMinutes: 120,
        rateMultiplier: [1.3, 2.2],
      },
      {
  ...
  },
  {
    ...
    services: [
      {
        title: 'Levantamento de parede em alvenaria',
        durationMinutes: 480,
        rateMultiplier: [4, 7],
      },
      {
        ...
        durationMinutes: 480,
        rateMultiplier: [3.5, 6],
      },
      {
        title: 'Reboco de parede',
        durationMinutes: 360,
        rateMultiplier: [3, 5],
      },
      {
        title: 'Demolição de parede',
        durationMinutes: 240,
        rateMultiplier: [2, 3.5],
      },
      {
        title: 'Reforma de churrasqueira',
        durationMinutes: 480,
        rateMultiplier: [4, 6.5],
      },
    ],
  },
  {
    name: 'Azulejista',
    namePlural: 'Azulejistas',
    slug: 'azulejista',
    category: 'Alvenaria e Acabamento',
    ...
    services: [
      ...
      },
      {
        title: 'Rejuntamento',
        durationMinutes: 180,
        rateMultiplier: [1.5, 2.8],
      },
      {
        title: 'Revestimento de box',
        durationMinutes: 300,
        rateMultiplier: [2.5, 4.2],
      },
      {
        title: 'Nivelamento de piso',
        durationMinutes: 240,
        rateMultiplier: [2, 3.5],
      },
      {
        title: 'Revestimento de parede 3D',
        durationMinutes: 360,
        rateMultiplier: [3, 5],
      },
    ],
  },
  {
    ...
    services: [
      ...
      {
        title: 'Sanca aberta com iluminação LED',
        durationMinutes: 480,
        rateMultiplier: [4.5, 7],
      },
      {
      ...
      {
        title: 'Nicho em gesso',
        durationMinutes: 180,
        rateMultiplier: [1.5, 2.6],
      },
      {
        title: 'Reparo de trinca em forro',
        durationMinutes: 120,
        rateMultiplier: [1, 1.8],
      },
    ],
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        durationMinutes: 300,
        rateMultiplier: [2.5, 4.5],
      },
      {
        title: 'Pintura de portas e batentes',
        durationMinutes: 240,
        rateMultiplier: [2, 3.2],
      },
      {
  ...
  },
  {
    ...
    services: [
      {
        title: 'Armário planejado sob medida',
        durationMinutes: 480,
        rateMultiplier: [5, 9],
      },
      {
        title: 'Painel de TV sob medida',
        durationMinutes: 360,
        rateMultiplier: [3.5, 6],
      },
      {
      ...
      {
        title: 'Bancada em madeira maciça',
        durationMinutes: 360,
        rateMultiplier: [3.5, 6.5],
      },
      {
        title: 'Restauro de móvel antigo',
        durationMinutes: 300,
        rateMultiplier: [2.5, 4.5],
      },
    ],
  },
  {
    ...
    namePlural: 'Montadores de Móveis',
    ...
    services: [
      ...
      {
        title: 'Montagem de cama box',
        durationMinutes: 60,
        rateMultiplier: [0.7, 1.2],
      },
      {
        title: 'Montagem de cozinha modulada',
        durationMinutes: 480,
        rateMultiplier: [4, 7],
      },
      {
        title: 'Desmontagem para mudança',
        durationMinutes: 180,
        rateMultiplier: [1.5, 2.6],
      },
      {
        title: 'Fixação de painel de TV na parede',
        durationMinutes: 90,
        rateMultiplier: [0.9, 1.5],
      },
    ],
  },
  {
    ...
    services: [
      {
        title: 'Instalação de box de vidro temperado',
        durationMinutes: 240,
        rateMultiplier: [2.5, 4.5],
      },
      {
      ...
      {
        title: 'Janela de correr em vidro temperado',
        durationMinutes: 300,
        rateMultiplier: [3, 5.5],
      },
      {
  ...
  },
  {
    ...
    services: [
      {
        title: 'Portão de ferro sob medida',
        durationMinutes: 480,
        rateMultiplier: [5, 9],
      },
      {
        title: 'Grade de proteção para janela',
        durationMinutes: 240,
        rateMultiplier: [2.2, 4],
      },
      {
        title: 'Corrimão em aço',
        durationMinutes: 300,
        rateMultiplier: [3, 5],
      },
      {
        title: 'Estrutura metálica para cobertura',
        durationMinutes: 480,
        rateMultiplier: [5.5, 9],
      },
      {
        title: 'Solda e reparo de portão',
        durationMinutes: 120,
        rateMultiplier: [1.2, 2.2],
      },
    ],
  },
  {
    ...
    services: [
      {
        title: 'Abertura de porta emergencial',
        durationMinutes: 60,
        rateMultiplier: [1, 2],
      },
      {
        title: 'Troca de segredo de fechadura',
        durationMinutes: 60,
        rateMultiplier: [0.8, 1.4],
      },
      {
        title: 'Instalação de fechadura digital',
        durationMinutes: 120,
        rateMultiplier: [1.5, 2.8],
      },
      {
        title: 'Cópia de chave codificada',
        durationMinutes: 30,
        rateMultiplier: [0.5, 1],
      },
      {
        title: 'Instalação de fechadura tetra-chave',
        durationMinutes: 90,
        rateMultiplier: [1.1, 2],
      },
    ],
  },
  {
    name: 'Jardineiro',
    namePlural: 'Jardineiros',
    slug: 'jardineiro',
    category: 'Segurança e Áreas Externas',
    ...
    services: [
      ...
      {
        title: 'Sistema de irrigação automatizada',
        durationMinutes: 360,
        rateMultiplier: [3.5, 6],
      },
    ],
